	...
	return (
		<Grid className='article-list'>
			{props.articles.map((article) => (
				<ArticleEntry key={article.id} article={article} user={props.user} exportOptions={props.exportOptions} deleteIt={props.deleteIt} convertIt={props.convertIt} addIt={props.addIt} topStoryMode={props.topStoryMode} toggleConvert={props.toggleConvert} isConverting={props.isConverting} isGuest={props.isGuest} toggleMembersOnly={props.toggleMembersOnly} />
			))}
		</Grid>
	);
}
