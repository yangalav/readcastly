          ...
          <div className="readcasts-topstories">
             {this.props.topStoryMode ?
              (<div className="switcher">
                <Col sm={2} xs={6}>
                  <Button bsStyle="primary" block onClick={this.props.toggleView.bind(this)}>Top stories</Button>
                </Col>
                <Col sm={2} xs={6}>
                  <Button bsStyle="default" block onClick={this.props.toggleView.bind(this)}>Your readcasts</Button>
                </Col>
              </div>) :
              (<div className="switcher">
                <Col sm={2} xs={6}>
                  <Button bsStyle="default" block onClick={this.props.toggleView.bind(this)}>Top stories</Button>
                </Col>
                <Col sm={2} xs={6}>
